...
- [Certainty Factor Algebra](#certainty-factor-algebra)
- [Installation & Usage](#installation--usage)
- [Project Structure](#project-structure)
- [Academic Context & References](#academic-context--references)
...
**Secure-Log-Parser-AI** is an intelligent system that thinks, reasons, and explains its findings like a human security analyst. It directly addresses the "black box" problem of modern ML by providing natural language justifications for every detection.
...
<img width="1440" height="1312" alt="image" src="https://github.com/user-attachments/assets/85832521-6a62-4a4f-8391-ad8d0adb0c59" />
...
| Benefit | Description |
|---|---|
| **Explainability** | When a threat is flagged, the system explains *why* in plain English, aiding SOC analysts in rapid decision-making. |
| **No Training Data Required** | Unlike deep learning, this system works immediately using expert-encoded knowledge. |
| **Predictable & Interpretable** | Rules are transparent and predictable, unlike many neural network patterns. |
| **Handles Uncertainty** | Real-world security data is often incomplete or messy; Certainty Factors provide a rigorous way to quantify this. |
...
| **Statistical** | Z-score + Moving averages | Outliers in event rates, payload sizes |
| **Behavioral** | UEBA + Sequence patterns | User profiling, peer group analysis, attack chains |
| **Meta-Reasoning** | CF algebra + Dempster-Shafer | Evidence combination, conflict resolution |
...
| AUTH-002 | Credential Stuffing | 0.90 | 10+ attempts with different usernames, <10% success rate |
...
For evidence pointing in the **same direction**:

```
CF_combined = CF1 + CF2 × (1 - CF1)
```

For evidence pointing in **opposite directions**:
...
**2. Analyze a log file for anomalies:**
...
This project serves as a practical implementation of fundamental AI concepts, supervised by:
...
**Author**: Taki Eddine Rami &nbsp;|&nbsp; **Version**: 1.0.0 &nbsp;|&nbsp; **License**: MIT &nbsp;|&nbsp; **Last Updated**: February 2026
